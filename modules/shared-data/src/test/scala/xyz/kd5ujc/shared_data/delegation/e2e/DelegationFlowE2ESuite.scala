...
import xyz.kd5ujc.shared_data.testkit.DelegationTestFixture
...
object DelegationFlowE2ESuite extends SimpleIOSuite {
  ...
  test("E2E: Complete delegation creation and submission flow") {
    for {
      ...
      delegationState = DelegationManager
        .initializeAgentDelegationState(testAgentAddress, advancedReputation)
        .copy(
      ...
      marketTransaction = DelegationDelegationTestFixture.createMarketTransaction(
  ...
  test("E2E: Delegation revocation and transaction rejection") {
    for {
      ...
      failingTransaction = DelegationTestFixture.createMarketTransaction(
        delegatorAddress = testDelegatorAddress,
        sessionKey = testSessionPublicKey,
        operation = "market_create"
      )
  ...
  test("E2E: Expired delegation handling") {
    for {
      ...
      expiredTransaction = DelegationTestFixture.createMarketTransaction(
        delegatorAddress = testDelegatorAddress,
        sessionKey = testSessionPublicKey,
        operation = "market_create"
      )
  ...
  test("E2E: Scope violation detection") {
    for {
      ...
      unauthorizedTransaction = DelegationTestFixture.createGovernanceTransaction(
        delegatorAddress = testDelegatorAddress,
        sessionKey = testSessionPublicKey,
      ...
      authorizedTransaction = DelegationTestFixture.createMarketTransaction(
        delegatorAddress = testDelegatorAddress,
        sessionKey = testSessionPublicKey,
  ...
  test("E2E: Spending limit enforcement") {
    for {
      ...
      validSpendTx = DelegationTestFixture.createMarketTransaction(
        delegatorAddress = testDelegatorAddress,
        sessionKey = testSessionPublicKey,
        operation = "market_create",
      ...
      excessiveSpendTx = DelegationTestFixture.createMarketTransaction(
        delegatorAddress = testDelegatorAddress,
        sessionKey = testSessionPublicKey,
        operation = "market_create",
  ...
  test("E2E: Emergency revocation and slashing") {
    for {
      ...
      failingTx1 = DelegationTestFixture.createMarketTransaction(
        delegatorAddress = "delegator1",
        sessionKey = "session_key_1",
        operation = "market_create"
      )

      failingTx2 = DelegationTestFixture.createGovernanceTransaction(
  ...
  test("Performance: High-frequency delegation validation") {
    for {
      ...
      results <- (1 to 100).toList.traverse { i =>
        val tx = DelegationTestFixture.createMarketTransaction(
          delegatorAddress = testDelegatorAddress,
          sessionKey = testSessionPublicKey,
          operation = "market_create",
      ...
      concurrentResults <- (1 to 50).toList.parTraverse { i =>
        val tx = DelegationTestFixture.createGovernanceTransaction(
          delegatorAddress = testDelegatorAddress,
          sessionKey = testSessionPublicKey,
          operation = "governance_vote",
  ...
  test("Integration: Multi-relayer delegation coordination") {
    for {
      ...
      tx1 = DelegationTestFixture.createMarketTransaction(
        delegatorAddress = testDelegatorAddress,
        sessionKey = testSessionPublicKey,
        operation = "market_create",
      ...
      tx2 = DelegationTestFixture.createGovernanceTransaction(
        delegatorAddress = testDelegatorAddress,
        sessionKey = testSessionPublicKey,
        operation = "governance_vote",
      ...
      tx3 = DelegationTestFixture.createMarketTransaction(
        delegatorAddress = testDelegatorAddress,
        sessionKey = testSessionPublicKey,
